  ...
  programs.ghostty = {
    ...
    settings = {
      ...
      keybind = [
        ...
        "${leader-key}>,=prompt_tab_title"
        "${leader-key}>x=close_surface"
        ...
        "${leader-key}>shift+h=resize_split:left,100"
        "${leader-key}>shift+j=resize_split:down,100"
        "${leader-key}>shift+k=resize_split:up,100"
        "${leader-key}>shift+l=resize_split:right,100"
